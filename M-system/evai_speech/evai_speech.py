...
#os.system("gnome-terminal -e 'xwinwrap -ni -o 1.0 -fs -s -st -sp -b -nf -- mplayer -wid WID -quiet -nosound -loop 0 /home/song/下载/M-system/evai_speech/resources/normal.mp4 -zoom -x 1920 -y 1080'")  #桌面建模
#os.system("gnome-terminal -e 'python /home/song/下载/M-system/evai_speech/catch.py'")  #开启视频捕捉
    ...
    while True:
		...
		'''
            ...
            if ans is 1:
                ...
                play_audio_file('resources/wozai.mp3')
                ...
                if rec_count > 0:
                    ...
                    sil_count += 1
                    #print('silence')
                if (sil_count > 1 and rec_count > 2):
		    ...
		    print(type(text))
                    ...
                    if text.find('识别错误')==-1:
                        sessiontemp1=UNITbigturn(face,text,gender)
                        #ring_buffer.clear()
